 ...
 *
 */
class JqimageresizeHelper extends AppHelper {
    /**
     * SECURITY:
    ...
    function resize($imagePath, $opts = null) {
        ...
        # start configuration
        $cacheFolder = 'img/tempimages/'; # path to your cache folder, must be writeable by web server
        $remoteFolder = $cacheFolder . 'remotephoto/'; # path to the folder you wish to download remote images into

        $defaults = array('crop' => false, 'scale' => 'false', 'thumbnail' => false, 'maxOnly' => false,
            'canvas-color' => '#FFFFFF', 'output-filename' => false,
            'cacheFolder' => $cacheFolder, 'remoteFolder' => $remoteFolder, 'quality' => 100, 'cache_http_minutes' => 20);
        ...
        if (file_exists($imagePath) == false) {
            $imagePath = APP . WEBROOT_DIR . $imagePath;
        ...
        $rpath = 'img/';
        return str_replace($rpath, '', $newPath);
    }
